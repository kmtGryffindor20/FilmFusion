...
urlpatterns = [
    ...
    path('videos/<int:movie_id>/', views.MovieVideoListAPIView.as_view()),
    path('reviews/<int:movie_id>/', views.MovieReviewsListCreateAPIView.as_view()),
    path('recommendations/', views.RecommendMoviesAPIView.as_view()),
